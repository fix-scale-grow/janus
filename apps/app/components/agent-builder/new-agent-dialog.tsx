				...
				<div className="flex flex-col gap-4">
					<div className="flex flex-col gap-1.5">
						...
						<Input
							...
							placeholder="Inspection prep brief"
							value={name}
						/>
					</div>
					...
					<div className="flex flex-col gap-1.5">
						...
						<Textarea
							...
							placeholder="The day before a roof inspection, gather the job history and post a short brief for whoever owns the deal."
							rows={3}
							value={job}
						/>
					</div>
					...
					<div className="flex flex-col gap-1.5">
						...
						<p className="text-muted-foreground text-xs">
							{channel
								? channel.isMember
									? `Janus is already in #${channel.name}.`
									: `Janus is not in #${channel.name} yet. It joins when you create this.`
