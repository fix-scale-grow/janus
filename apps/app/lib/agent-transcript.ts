...
const VERBS: Record<string, string> = {
	...
	propose_drawing_tags: "Proposed services for the drawing's shapes",
	propose_estimate_lines: "Proposed line items for the estimate",
	review_drawing: "Reviewed the drawing for gaps",
